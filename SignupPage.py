...
class SignupPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button_sign_up = tk.Button(self, text="Sign Up",command=lambda: self.signup(entry_username,entry_email,entry_phone,entry_password,entry_confirm_password))
    ...
    def signup(self,name_entry,email_entry,phone_entry, password_entry,confirm_password_entry):
        # to check if correct account exists and two password match
        self.controller.signup(name_entry.get(),email_entry.get(),phone_entry.get(),password_entry.get(),confirm_password_entry.get())
